  ...
  <div
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 mt-6">
      <div>
        ...
        <div class="mt-1">
          <date-picker id="from" v-model="filters.start" :show-second="false" :minute-step="15" :disabled-date="disabledStartDate"  :disabled-time="disabledStartTime" type="datetime"
      ...
      <div>
        ...
        <div class="mt-1">
          <date-picker id="to" v-model="filters.end" :show-second="false" :disabled-date="disabledEndDate"  :disabled-time="disabledEndTime" :minute-step="15" type="datetime"
                       class="w-full"></date-picker>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    buildFilterUrl() {
      ...
      //return "start=2022-02-15T21:00:00.000000Z&end=2022-02-16T21:00:00.000000Z"
    },
    ucFirst(str) {
    ...
    disabledEndDate(date) {
      const startdate = new Date(this.filters.start);
      if(startdate.getHours() == 0){
        return date < new Date(this.filters.start)
      }
      return date < new Date(this.filters.start - 3600 * 1000 *24)
    },
    disabledEndTime(date){
      ...
      return date < new Date(this.filters.start - 3600 * 1000)
    }
  }
}
</script>
